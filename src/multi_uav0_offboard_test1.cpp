...
int main(int argc, char **argv)
{
    ...
    ros::init(argc, argv, "multi_uav0_offboard_test1_Node");
    ros::NodeHandle nh;
    ros::Subscriber state_sub = nh.subscribe<mavros_msgs::State>
