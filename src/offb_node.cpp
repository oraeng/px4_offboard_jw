...
// mavros_msgs::State current_position;
// void state_cb(const geometry_msgs::position::ConstPtr& msg){
//     current_position = *msg;
// }

int main(int argc, char **argv)
{
    ros::init(argc, argv, "offb_node_Node");
    ros::NodeHandle nh;
...
*/
    ...
    //pose.pose.position.x = 0;
    //pose.pose.position.y = 0;
    bodyrate.twist.linear.x = 0.5;
    // bodyrate.twist.linear.z = 0.5*(2-1);
